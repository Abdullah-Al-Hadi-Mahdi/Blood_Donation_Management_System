            ...
            <div class="wrapper wrapper--w790">
              ...
              { 
                 ...
                 if($_SERVER["REQUEST_METHOD"] == "POST") {
                  ...
                  if($row['unit'] > $unit) {
                      $sql="INSERT INTO blood_request VALUES('$request_id','$requestor_id','$unit','$blood_group','$request_date','$reason','$status','$action','$admin_id')";
                      ...
                      $sql = "INSERT INTO blood_request VALUE('$request_id','$requestor_id','$unit','$blood_group','$request_date','$reason','rejected','Stock Low','$admin_id')";
